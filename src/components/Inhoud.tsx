			...
			<main>
				<section>
					...
					<div className="mummi">
						...
						<div className="mtp-imgs">
							<img src="./hieroglyphen.png" alt="" />
				...
				<section>
					...
					<div className="mummi">
						<div>
							<p>
								De Egyptenaren maakten prachtige <strong>schilderingen</strong> en <strong>beeldhouwwerken</strong>. In tempels en graven schilderden ze verhalen over de goden, het dagelijks leven en de natuur. Deze schilderingen zijn erg kleurrijk
								en vol symboliek. Ook maakten ze beelden van farao's en goden, vaak heel groot en indrukwekkend.
							</p>
				...
				<section>
					...
					<div className="mummi">
						<div>
							<p>
								Naast beeldende kunst hielden de oude Egyptenaren van <strong>muziek</strong> en <strong>dans</strong>. Ze maakten gebruik van instrumenten zoals fluiten, harpen en tamboerijnen bij feestelijke gelegenheden. Verhalen en gedichten
								werden opgeschreven en voorgelezen, wat hielp bij het doorgeven van kennis en tradities.
							</p>
						</div>
						<img src="./papyrus.png" alt="" />
					</div>
				</section>
				<nav>
